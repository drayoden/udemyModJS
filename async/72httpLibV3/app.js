...
//                  or  https://jsonplaceholder.typicode.com/users
...
// http.put('https://jsonplaceholder.typicode.com/users/7', data)  // note the end of the URL to specify which user to update
//     .then(data => console.log(data))
//     .catch(err => console.log(err));
...
// test delete
http.delete('https://jsonplaceholder.typicode.com/users/5')  // note the end of the URL to specify which user to delete
    .then(data => console.log(data))
    .catch(err => console.log(err));
